...
_PEER_GROUPS = {
    ...
    '工具機/線性傳動': ['2049', '4583', '7750', '4538', '8255', '1597', '4540'],
    '晶圓代工': ['2330', '2303', '6770', '5347'],
    # IC 設計（Phase 2 新增，高信心 — 都是純 IC 設計公司）
    'IC 設計': ['2454', '3034', '2379', '3443', '6533', '3529', '6415', '3227', '8016'],
    # 矽晶圓 / 半導體材料（Phase 2 新增；2026-04-27 移除 8374 羅昇 — 工業自動化代理商誤列）
    '矽晶圓/半導體材料': ['6488', '5483', '3535'],
    # GaAs 化合物半導體代工三雄（Phase 2 新增）
    'GaAs 化合物半導體代工': ['8086', '3105', '2455'],
    'IC 封測 OSAT': ['3711', '6239', '2449', '2441', '3374'],
    '面板': ['3481', '2409', '6116'],
    '光學鏡頭': ['3008', '3406', '3019'],
    # 散熱模組（2026-04-27 修正：移除 4540 全球傳動為工具機誤列；補 3338/3324/3653/6230）
    '散熱模組': ['3017', '3324', '3653', '6230', '2421', '3338', '3483'],
