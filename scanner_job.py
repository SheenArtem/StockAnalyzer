...
def main():
    ...
    screener = MomentumScreener(config=config, progress_callback=progress)
    ...
    # Save results
    paths = MomentumScreener.save_results(result, args.output_dir)
    progress(f"Saved to {paths[0]}")
